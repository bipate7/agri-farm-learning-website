...
const Footer = () => {
  return (
    <footer className="bg-farm-primary text-white">
          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <form className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-md text-farm-text bg-white focus:outline-none focus:ring-2 focus:ring-farm-accent"
                required
              />
              <button
                type="submit"
                className="px-4 py-2 bg-farm-accent hover:bg-farm-accent/90 text-white rounded-md transition-colors whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>
